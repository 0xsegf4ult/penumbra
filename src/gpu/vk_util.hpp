...
constexpr VkBufferUsageFlags2 decode_buffer_usage(GPUBufferUsage usage)
{
	...
	case GPU_BUFFER_STORAGE:
		return VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
	case GPU_BUFFER_UNIFORM:
		return VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT;
	case GPU_BUFFER_INDIRECT:
		return VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT | VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
	case GPU_BUFFER_UPLOAD:
		return VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_2_TRANSFER_DST_BIT;
	case GPU_BUFFER_VERTEX:
		return VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_2_TRANSFER_DST_BIT;
...
constexpr VkPipelineStageFlags2 gpu_stage_to_vk(GPUStage stage)
{
	...
	if(stage & GPU_STAGE_MESH_SHADER)
		res |= VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT;
	...
	if(stage & GPU_STAGE_TRANSFER)
		res |= (VK_PIPELINE_STAGE_2_COPY_BIT | VK_PIPELINE_STAGE_2_CLEAR_BIT);
	if(stage & GPU_STAGE_HOST)
		res |= VK_PIPELINE_STAGE_2_HOST_BIT;
