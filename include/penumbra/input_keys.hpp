...
constexpr kbd_scancode sdl_scancode_parse(SDL_Scancode scancode)
{
	/*
	 ...
	 */
        ...
        return static_cast<kbd_scancode>(scancode);
}

constexpr SDL_Scancode scancode_to_sdl(kbd_scancode scancode)
{
	return static_cast<SDL_Scancode>(scancode);
}

enum mouse_button_code : u8
{
	INPUT_MOUSE0 = 0,
	INPUT_MOUSE_LEFT = 0,
	INPUT_MOUSE1 = 1,
	...
	INPUT_MOUSE3 = 3,
	INPUT_MOUSE4 = 4,
	INPUT_MOUSE_INVALID = 5
};

constexpr mouse_button_code sdl_mouse_parse(u8 code)
{
	switch(code)
	{
	case 1:
