...
export module penumbra.core:input_keys;

namespace penumbra
{

export enum KeyboardScancode : uint32_t
{
	SCANCODE_UNKNOWN = 0,
...
export constexpr KeyboardScancode sdl_scancode_parse(SDL_Scancode scancode)
{
	/*
	...
	return static_cast<KeyboardScancode>(scancode);
}

export constexpr SDL_Scancode scancode_to_sdl(KeyboardScancode scancode)
{
